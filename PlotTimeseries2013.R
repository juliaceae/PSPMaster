...
write.csv(Det.freq.table, paste(outpath.plot.points,"State_2014_detection_frequencies.csv",sep="")) 

write.csv(mydata_clean_noV, paste(outpath.plot.points,"State_2014_mydata_clean_noV.csv",sep="")) 
